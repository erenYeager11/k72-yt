    ...
    <div id="fullscreennav" className="text-white h-screen overflow-hidden w-full absolute bg-black">
      ...
      <div className="py-35">
        <div className="link relative  border-t-1 border-white">
          <h1 className="font-[font1] text-[6vw] text-center leading-[0.8] pt-4 uppercase">Projects</h1>
          <div className="moveLink absolute text-black flex top-0 bg-[#D3FD50]">
            <div className="moveX flex items-center">
              <h2 className="whitespace-nowrap font-[font1] text-[6vw] text-center leading-[0.8] pt-4 uppercase">Pour Tout voir</h2>
              <img className="h-26 shrink-0 rounded-full w-70 object-cover"  src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt=""/>
              <h2 className="whitespace-nowrap font-[font1] text-[6vw] text-center leading-[0.8] pt-4 uppercase">Pour Tout voir</h2>
              <img className="h-26 shrink-0 rounded-full w-70 object-cover"  src="https://k72.ca/uploads/caseStudies/PJC/Thumbnails/PJC_SiteK72_Thumbnail_640x290-640x290.jpg"/>
            </div>
            <div className="moveX flex items-center">
              <h2 className="whitespace-nowrap font-[font1] text-[6vw] text-center leading-[0.8] pt-4 uppercase">Pour Tout voir</h2>
              <img className="h-26 shrink-0 rounded-full w-70 object-cover"  src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt=""/>
